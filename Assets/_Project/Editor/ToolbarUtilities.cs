...
public static class ToolbarUtilities
{
    ...
    private static void Update()
    {
        ...
        if (_scenePaths == null)
        {
            ...
            string folderName = Application.dataPath + "/_Project/Scenes";
    ...
    {
        //if (GUILayout.Button("Reload", GUILayout.Width(50.0f)) && Application.isPlaying)
        //{
        ...
        {
            {
                ...
                int newSceneIndex = EditorGUILayout.Popup(sceneIndex, _sceneNames, GUILayout.Width(150));
